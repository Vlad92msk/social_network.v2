...
📦social_network
 ...
 ┃  ┃  ┣ 📁api
 ┃  ┃  ┣ 📁_ui
 ┃  ┃  ┃  ┣ 📁base (базовые компоненты + реэкспорт из библиотек - "кубики" из которых все строим)
 ┃  ┃  ┃  ┣ 📁common (комопненты для этого проекта - в коце приписываем "C"-'common' <ButtonC/>, <CommonText/> и тд)
 ┃  ┃  ┃  ┣ 📁сomponents (отдельные комопненты типа <Body/>, <Html/>, <RootMenuSettings/> и тд)
 ┃  ┃  ┃  ┗ 📁styles
