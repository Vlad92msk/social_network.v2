...
import { CacheEntry, CacheUtils } from '../../../storage/modules/cache/cache-module.service'
import { IStorage, StorageType } from '../../../storage/storage.interface'
import { StorageKeyType } from '../../../storage/utils/storage-key'
import { CacheConfig, CreateApiClientOptions } from '../types/api1.interface'
...
export class QueryStorage {
  ...
  private startCleanupInterval(): void {
    ...
    const cleanupConfig = typeof this.globalCacheConfig === 'object'
      ? this.globalCacheConfig.cleanup
      : this.defaultCacheOptions.cleanup
