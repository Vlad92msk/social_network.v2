...
export const profileApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getProfileInfo: builder.query<
      UserProfileInfo,
      Parameters<typeof profileApiInstance.getProfileInfo>[0]
    >({
      query: (params) => {
    ...
    getProfiles: builder.query<
      UserProfileInfo[],
      Parameters<typeof profileApiInstance.getProfiles>[0]
    >({
      query: (params) => {
    ...
    removeProfile: builder.mutation<
      any,
      Parameters<typeof profileApiInstance.removeProfile>[0]
    >({
      query: (params) => {
