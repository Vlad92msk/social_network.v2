 ...
 */
export const isBlobOrFile = (obj: any): obj is Blob | File =>
  obj instanceof Blob || obj instanceof File;

/**
 * Проверяет, является ли объект похожим на File с полем src
 */
export const isFileWithSrc = (obj: any): obj is FileWithSrc =>
  obj && typeof obj === 'object' && 'src' in obj;
...
export const getBestAvailableImage = (
  ...
  console.warn(`📁 Available images:`, Object.keys(images).filter(key => !key.includes('.')).slice(0, 10));
