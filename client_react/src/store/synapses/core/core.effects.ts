...
type Effect = ReturnType<typeof createEffect<IDBCore, DispatcherType, ApiType, Record<string, void>, ExternalStorages>>
...
const getProfileInfo: Effect = createEffect((action$, state$, externalStates, { coreDispatcher }, { userProfileAPi }) =>
  action$.pipe(
